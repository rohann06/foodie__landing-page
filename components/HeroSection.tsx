...
const HeroSection = () => {
  return (
    <div
      id="hero"
      className=" flex flex-col-reverse lg:flex-row justify-between items-center mt-10"
    >
      <div>
        <div className=" text-[30px] lg:text-[60px] font-extrabold  font-Montserrat text-[#4C4C4C] py-5">
          <h1>
      ...
      <div>
        <Image src={herobackgroundimage} height={700} width={760} alt="image" />
      </div>
    </div>
  );
};
